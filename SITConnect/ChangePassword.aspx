<%@ Page Language="C#" Title="Change Password" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ChangePassword.aspx.cs" Inherits="SITConnect.ChangePassword" %>
...
<asp:Table id="Table1" runat="server"
    ...
    <asp:TableRow>
                    <asp:TableCell>
                        <asp:Label ID="Label1" runat="server" Text="Enter Old Password"></asp:Label><span style="color: #FF0000">&nbsp;*</span>
                    </asp:TableCell>
                    <asp:TableCell>
                        <asp:TextBox ID="tb_old_password" runat="server" Height="36px" Width="280px" keyup="" onkeyup="btn_checkpassword_click"></asp:TextBox>
                    </asp:TableCell>
                    <asp:TableCell>
                        <img id="hide_show_old_password" src="Images/hide_password.svg" style="position:relative; left:-55px;" onclick="javascript:hide_or_show_old_pw()" width="25" height="25" />
                    </asp:TableCell>
                    <asp:TableCell>
                        <asp:Label ID="Label2" style="position:relative; left:-55px;" runat="server" Text="pwdchecker"></asp:Label>
                    </asp:TableCell>
                </asp:TableRow>
...
<script type="text/javascript">
    ...
    function hide_or_show_old_pw() {

        var img_link = document.getElementById("hide_show_old_password").src


        if (img_link.slice(img_link.length - 24) == "Images/show_password.svg") {
            document.getElementById("hide_show_old_password").src = "Images/hide_password.svg";
            document.getElementById('<%=tb_old_password.ClientID %>').type = 'password';

            
        } else {
            document.getElementById("hide_show_old_password").src = "Images/show_password.svg";
            document.getElementById('<%=tb_old_password.ClientID %>').type = 'text';
